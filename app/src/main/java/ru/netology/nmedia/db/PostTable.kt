...
object PostTable {
    ...
    val DDL = """
        CREATE TABLE $NAME (
            ...
            ${Column.SUM_VISIBLE.columnName} INTEGER NOT NULL DEFAULT 1
        );
        """.trimIndent()

    val ALL_COLUMNS_NAMES =
        Column.values().map { it.columnName }.toTypedArray()   //массив строк в котором все колонки

    // названия таблиц и колонок храним в отдельном обьекте
